    ...
    <nav style={{ backgroundColor: "#C3C3C3" }}>
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <Link href='/'><Image src="/Logo.png" alt="Logo" width={50} height={50} /></Link> 
          <div className="hidden md:flex ml-10 text-lg md:text-xl">
            ...
            <Link href="https://medport-global.vincere.io/careers/" className="text-white font-medium hover:text-grey mx-2">Job/Vacancies</Link>
      ...
      {isOpen && (
        <div className="px-5 pb-3 md:hidden text-lg">
          ...
          <Link href="https://medport-global.vincere.io/careers/" className="block text-white font-medium hover:text-grey mb-2">Job/Vacancies</Link>
